...
var InvalidAbiItemError = class extends BaseError {
  constructor({ signature }) {
    ...
    __publicField(this, "name", "InvalidAbiItemError");
  }
};
var UnknownTypeError = class extends BaseError {
  constructor({ type }) {
    ...
    __publicField(this, "name", "UnknownTypeError");
  }
};
var UnknownSolidityTypeError = class extends BaseError {
  constructor({ type }) {
    ...
    __publicField(this, "name", "UnknownSolidityTypeError");
  }
};
...
var InvalidAbiParameterError = class extends BaseError {
  constructor({ param }) {
    ...
    __publicField(this, "name", "InvalidAbiParameterError");
  }
};
var InvalidAbiParametersError = class extends BaseError {
  constructor({ params }) {
    ...
    __publicField(this, "name", "InvalidAbiParametersError");
  }
};
var InvalidParameterError = class extends BaseError {
  constructor({ param }) {
    ...
    __publicField(this, "name", "InvalidParameterError");
  }
};
var SolidityProtectedKeywordError = class extends BaseError {
  constructor({ param, name: name2 }) {
    ...
    __publicField(this, "name", "SolidityProtectedKeywordError");
  }
};
var InvalidModifierError = class extends BaseError {
  constructor({
    ...
    __publicField(this, "name", "InvalidModifierError");
  }
};
var InvalidFunctionModifierError = class extends BaseError {
  constructor({
    ...
    __publicField(this, "name", "InvalidFunctionModifierError");
  }
};
var InvalidAbiTypeParameterError = class extends BaseError {
  constructor({
    ...
    __publicField(this, "name", "InvalidAbiTypeParameterError");
  }
};
...
var InvalidSignatureError = class extends BaseError {
  constructor({
    ...
    __publicField(this, "name", "InvalidSignatureError");
  }
};
var UnknownSignatureError = class extends BaseError {
  constructor({ signature }) {
    ...
    __publicField(this, "name", "UnknownSignatureError");
  }
};
var InvalidStructSignatureError = class extends BaseError {
  constructor({ signature }) {
    ...
    __publicField(this, "name", "InvalidStructSignatureError");
  }
};
...
var InvalidParenthesisError = class extends BaseError {
  constructor({ current, depth }) {
    ...
    __publicField(this, "name", "InvalidParenthesisError");
  }
};
...
var CircularReferenceError = class extends BaseError {
  constructor({ type }) {
    ...
    __publicField(this, "name", "CircularReferenceError");
  }
};
